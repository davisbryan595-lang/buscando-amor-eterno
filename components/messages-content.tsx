...
function MessagesContentInner() {
  ...
  return (
    <div className="pt-12 sm:pt-16 md:pt-20 pb-4 px-0 sm:px-4 lg:px-6 h-[calc(100vh-5rem)] md:h-[calc(100vh-5rem)] flex flex-col overflow-hidden">
      <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col md:flex-row gap-0 md:gap-4 lg:gap-6 min-h-0 overflow-hidden">
