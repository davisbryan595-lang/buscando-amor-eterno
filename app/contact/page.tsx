      ...
      <div className="pt-24 pb-20 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-gradient-to-br from-white to-rose-50 border border-rose-100 rounded-xl p-6 soft-glow">
              <Mail className="text-primary mb-4" size={32} />
              <h3 className="text-lg font-bold text-slate-900 mb-2">Email</h3>
              <p className="text-slate-600">
                <a href="mailto:support@buscandoamoreterno.com" className="hover:text-primary">
